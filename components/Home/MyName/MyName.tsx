...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a <span className="text-AAsecondary">software engineer</span> with a passion for full-stack development,<br className="2xl:block hidden" />
        I am a proficient developer capable of designing and developing complex applications with expertise in React and Node.js
