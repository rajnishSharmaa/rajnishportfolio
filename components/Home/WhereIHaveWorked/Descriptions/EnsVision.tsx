...
export default function EnsVision() {
  const tasks = [
    {
      text: "Worked on the front-end development using HTML/CSS , Bootstrap , JavaScript , React.js",
      keywords: ["Alchemy", "Wagmi", "Web3.js", "Moralis", "Ethers.js"],
    },
    {
      text: "Conducted tasks to ensure website functionality and quality.",
      ...
      <div className="flex flex-col space-y-5 max-w-xl px-4 md:px-0">
        <div className="flex flex-col spacey-y-2">
          ...
          <span className="text-gray-100 sm:text-lg text-sm font-Arimo tracking-wide">
            Software Developer<span className="text-AAsecondary"> Internship</span>
          </span>
          {/* Date */}
          <span className="font-mono text-xs text-gray-500">Nov 2022 - Jan 2023</span>
          {/* <span
