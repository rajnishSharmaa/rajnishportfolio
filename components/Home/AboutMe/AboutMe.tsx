...
export default function AboutMe(props) {
  const technologies = [
    ["React.js","Next.js", "JavaScript (ES6+)", "Bootstrap"],
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Rajnish Sharma, and I am a passionate software engineer and problem solver, dedicated to
